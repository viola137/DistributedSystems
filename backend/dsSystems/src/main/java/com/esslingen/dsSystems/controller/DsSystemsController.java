...
import com.esslingen.dsSystems.repository.DsSystemsRepository;
...
public class DsSystemsController {
	...
	public ResponseEntity<List<DsSystemsEntity>> getFilteredPets(@RequestBody DsSystemsEntity dsSystemEntity) {
	...
	@Transactional
	public ResponseEntity<DsSystemsEntity> addPet(@RequestBody DsSystemsEntity reqDsEntity) {
	...
	@Transactional
	public ResponseEntity<DsSystemsEntity> editPet(@RequestBody DsSystemsEntity reqDblabEntity) {
